...
namespace AztecQRGenerator.Tests
{
    ...
    public class AztecGeneratorTests
    {
        ...
        public void GenerateAztecCodeAsBitmap_ValidInput_ReturnsBitmap()
        {
            ...
            // Act
            Bitmap result = generator.GenerateAztecCodeAsBitmap(base64Data, correction, pixelDensity);
        ...
        [Test]
        public void GenerateAztecCodeAsBitmap_NullInput_ThrowsArgumentException()
        {
            // Arrange
            ...
            Assert.Throws<ArgumentException>(() =>
                generator.GenerateAztecCodeAsBitmap(base64Data, correction, pixelDensity));
        }
        ...
        [TestCase(300)]
        [TestCase(500)]
        public void GenerateAztecCodeAsBitmap_DifferentSizes_ReturnsCorrectSize(int size)
        {
            // Arrange
            string base64Data = Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes("Test"));
            int correction = 2;
            ...
            // Act
            Bitmap result = generator.GenerateAztecCodeAsBitmap(base64Data, correction, size);
        ...
        [TestCase(5)]
        [TestCase(10)]
        public void GenerateAztecCodeAsBitmap_DifferentCorrectionLevels_GeneratesSuccessfully(int correction)
        {
            // Arrange
            string base64Data = Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes("Test"));
            int pixelDensity = 300;
        ...
        [Test]
        public void GenerateAztecCodeToFile_ValidInput_ReturnsTrue()
        {
            // Arrange
            string base64Data = Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes("Test"));
            string fileName = $"test_aztec_{Guid.NewGuid()}.png";
            ...
            {
                // Act
                bool result = generator.GenerateAztecCodeToFile(base64Data, 2, 300, fileName, ImageFormat.Png);

                // Assert
                Assert.IsTrue(result);
                Assert.IsTrue(System.IO.File.Exists(outputPath), "Aztec code file should exist");
            }
            finally
            {
                // Cleanup
        ...
        public void GenerateAztecCodeToFile_NullFilePath_ThrowsArgumentException()
        {
            ...
            // Act & Assert
            Assert.Throws<ArgumentException>(() =>
                generator.GenerateAztecCodeToFile(base64Data, 2, 300, null, ImageFormat.Png));
        }
        ...
        public void GenerateAztecCodeToFile_NullFormat_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() =>
                generator.GenerateAztecCodeToFile(base64Data, 2, 300, fileName, null));
        }
        ...
        public void GenerateAztecCodeToFile_DifferentFormats_GeneratesSuccessfully(string extension, Type formatType)
        {
            // Arrange
            string base64Data = Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes("Test"));
            string fileName = $"test_aztec_{Guid.NewGuid()}.{extension}";
            string documentsPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
            string outputPath = System.IO.Path.Combine(documentsPath, "AztecQRGenerator", "Output", fileName);
            ...
            {
                // Act
                bool result = generator.GenerateAztecCodeToFile(base64Data, 2, 300, fileName, format);
        ...
        #region GenerateAztecBitmap Tests

        [Test]
        public void GenerateAztecBitmap_ValidInput_ReturnsTrue()
        {
            // Arrange
            string base64Data = Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes("Test"));
            string documentsPath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
            ...
            var filesBefore = System.IO.Directory.Exists(outputDir) 
                ? System.IO.Directory.GetFiles(outputDir, "AztecCode_*.png")
                : new string[0];

            try
            {
                // Act
                bool result = generator.GenerateAztecBitmap(base64Data, 2, 300);

                // Assert
                Assert.IsTrue(result);

                // Verify file was created
                var filesAfter = System.IO.Directory.GetFiles(outputDir, "AztecCode_*.png");
        ...
        [Test]
        public void GenerateAztecCodeAsBitmap_LargeData_GeneratesSuccessfully()
        {
            // Arrange
        ...
        [Test]
        public void GenerateAztecCodeAsBitmap_SpecialCharacters_GeneratesSuccessfully()
        {
            // Arrange
        ...
        [Test]
        public void GenerateAztecCodeAsBitmap_MinimumSize_GeneratesSuccessfully()
        {
            // Arrange
