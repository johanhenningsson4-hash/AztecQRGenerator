...
# Ultra-simple version to avoid PowerShell parsing issues
...
$packageFile1 = "AztecQRGenerator.Core\bin\Release\AztecQRGenerator.Core.1.4.0.nupkg"
$packageFile2 = "packages\AztecQRGenerator.Core.1.4.0\AztecQRGenerator.Core.1.4.0.nupkg"

$packageFile = $null

if (Test-Path $packageFile1) {
    $packageFile = $packageFile1
}
...
$readmePath = "$tempDir\NUGET_README.md"
...
if ($readmeExists) { 
    Write-Host "  ✓ README found" -ForegroundColor Green 
}
